...
if __name__ == '__main__':
    ...
    parser.add_argument('-fi', '--file', type=str, default='./data/smile/smiles.txt',
    ...
    parser.add_argument('-sc', '--smiles-column', type=str,
                        help="Column for SMILES in the CSV file.",default='smiles')
    ...
    parser.add_argument('-o', '--out-dir', type=str, default='./data/smile',
